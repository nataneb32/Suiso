...
export class CourseDescription1584854684103 implements MigrationInterface {
    name = 'CourseDescription1584854684103'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "course" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "price" integer NOT NULL, "description" varchar, "sellerId" integer)`, undefined);
        await queryRunner.query(`CREATE TABLE "temporary_course" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "price" integer NOT NULL, "description" varchar, "sellerId" integer, CONSTRAINT "FK_ac834cfbec6a7de3ab8d08b99f9" FOREIGN KEY ("sellerId") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`, undefined);
